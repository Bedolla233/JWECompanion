        ...
        {activeView === 'genomes' ? (
          ...
          <DigSites paddock={currentRoster} completedSites={completedSites} toggleSiteCompletion={toggleSiteCompletion} theme={t} />
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'flex', overflowX: 'auto', marginBottom: '20px', paddingBottom: '4px' }} className="custom-scrollbar">
                <div style={{
                  display: 'inline-flex',
                  background: t.bgCard,
                  border: `1px solid ${t.border}`,
                  ...
                  {paddocks.map(p => (
                    <div
                      ...
                      style={{
                        padding: '8px 14px',
                        background: p.id === activePaddockId ? t.primary : 'transparent',
                        color: p.id === activePaddockId ? t.bgMain : t.textMuted,
                        borderRadius: '6px',
                        cursor: p.id === activePaddockId ? 'default' : 'pointer',
                        display: 'flex',
                        alignItems: 'center',
                        gap: '8px',
                        fontWeight: 'bold',
                      ...
                      {p.id === activePaddockId ? (
                        <input 
                          ...
                          style={{
                            ...
                            border: 'none', 
                            borderBottom: `1px dashed ${t.bgMain}66`, 
                            color: t.bgMain, 
                            fontWeight: 'bold', 
                            outline: 'none', 
                            width: `${Math.max(p.name.length, 5)}ch`, 
                            minWidth: '60px',
                            fontSize: '13px',
                            padding: '0 0 2px 0'
                          }}
